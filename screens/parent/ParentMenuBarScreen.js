...
const ParentMenuBarScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.grid}>
        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('ParentAttendanceScreen')}>
          <Image source={require('../../assets/attendance.png')} style={styles.iconImage} />
          <Text style={styles.menuText}>ATTENDANCE</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('ParentAnnouncementsScreen')}>
          <Image source={require('../../assets/announcement.png')} style={styles.iconImage} />
          <Text style={styles.menuText}>ANNOUNCEMENT</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('ParentSchoolCalendarScreen')}>
          <Image source={require('../../assets/calendar.png')} style={styles.iconImage} />
          <Text style={styles.menuText}>SCHOOL CALENDAR</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('ParentChildInfoScreen')}>
          <Image source={require('../../assets/rfidlogs.png')} style={styles.iconImage} />
          <Text style={styles.menuText}>MY CHILD'S INFO</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('ParentSettingsScreen')}>
...
export default ParentMenuBarScreen;
