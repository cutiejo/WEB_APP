  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileSection}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ParentEditProfileScreen')} style={styles.editProfileButton}>
      ...
      <View style={styles.settingsContainer}>
        ...
        <TouchableOpacity
          style={styles.settingsItem}
          onPress={() => navigation.navigate('ParentChangePasswordScreen')}
        >
        ...
        <TouchableOpacity
          style={styles.settingsItem}
          onPress={() => navigation.navigate('ParentAboutScreen')}
        >
        ...
        <TouchableOpacity
          style={styles.settingsItem}
          onPress={() => navigation.navigate('ParentChildInfoScreen')}
        >
          <Icon name="account-group-outline" size={24} color="#137e5e" />
          <Text style={styles.settingsText}>Child's Information</Text>
        </TouchableOpacity>
