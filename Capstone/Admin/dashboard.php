...
$result = $conn->query("SELECT COUNT(id) as total_teachers FROM users");
if ($result && $row = $result->fetch_assoc()) {
...
<head>
    ...
    <style>
        ...
        .announcement-card {
            ...
            height: 70%;
            /* Make sure it fits within the container height */
        ...
        .recent-activity a::before {
            content: "\f0da";
            /* FontAwesome icon, like a chevron */
    ...
    <div class="main-content" id="main-content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <button class="btn btn-primary generate-report" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_students; ?>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total
                                        Teachers</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_teachers; ?>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-users fa-2x text-gray-300"></i>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_users; ?>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-users fa-2x text-gray-300"></i>
                ...
                <div class="announcement-container">
                    ...
                    <div class="announcement-section">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button class="btn btn-outline-warning" onclick="window.location.href='notice.php'"><i
