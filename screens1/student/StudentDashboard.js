    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <TouchableOpacity onPress={() => navigation.navigate('MenuBarScreen')}>
      ...
      <View style={styles.quickAccessMenu}>
        <TouchableOpacity style={styles.menuButton} onPress={() => navigation.navigate('AttendanceScreen')}>
        ...
        <TouchableOpacity style={styles.menuButton} onPress={() => navigation.navigate('TimesheetScreen')}>
          <View style={styles.iconBg}>
        ...
        <TouchableOpacity style={styles.menuButton} onPress={() => navigation.navigate('MenuBarScreen')}>
          <View style={styles.iconBg}>
